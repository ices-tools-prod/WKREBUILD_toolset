...
<div class="figure">
<img src="report/om_deviances.png" alt="plot of chunk plotsrdevs" width="92%" />
<p class="caption">plot of chunk plotsrdevs</p>
</div>
...
<div class="figure">
<img src="report/run_f0.png" alt="plot of chunk plotrunf0" width="92%" />
<p class="caption">plot of chunk plotrunf0</p>
</div>
...
<div class="figure">
<img src="report/plans.png" alt="plot of chunk plotplans" width="92%" />
...
names(statistics)
#>  [1] "SB0"     "minSB0"  "SBMSY"   "Ftarget" "FMSY"    "green"   "red"     "PSBMSY"  "PSBlim"  "PSB20B0" "risk1"   "risk2"   "risk3"   "C"       "CMSY"    "AAVC"    "IACC"   
#> [18] "PC0"

statistics$risk2
#> [[1]]
#> ~yearMeans(iterMeans(((SB/SBlim) < 1) > 0))
#> 
#> $name
#> [1] "once(P(SB<B[limit]))"
#> 
#> $desc
#> [1] "ICES Risk 2, probability that spawner biomass is above Blim once"
```
...
<div class="figure">
<img src="report/perf_bps.png" alt="plot of chunk plotbps" width="92%" />
<p class="caption">plot of chunk plotbps</p>
</div>
...
<div class="figure">
<img src="report/onruns.png" alt="plot of chunk plotssbruns" width="92%" />
